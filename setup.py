...
setup(
    ...
    url='https://github.com/jerabaul29/randommac',
    ...
    keywords='MAC address gestion in systems with Linux NetworkManager',
    ...
    data_files=[('data/OUI.list', ['data/OUI.list'])],
    ...
    entry_points={
        'console_scripts': [
            'randommac=randommac.randommac_commandline:main',
        ],
    },
)
